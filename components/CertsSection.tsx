...
export function CertsSection() {
  return (
    <div className="bg-bg2 py-24" id="certs">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-8">
          {CERTS.map((cert, i) => (
            <FadeIn key={cert.id} delay={i * 80}>
              <div className="group flex flex-col gap-4 bg-surface border border-[rgba(0,255,224,0.12)] p-9 transition-all duration-300 hover:border-[rgba(0,255,224,0.3)] hover:-translate-y-0.5 hover:shadow-[0_0_30px_rgba(0,255,224,0.15)]">
                ...
                <p className="font-mono text-[10px] text-text3 tracking-[1px]">{cert.id}</p>
              </div>
            </FadeIn>
          ))}
        </div>
